...
void main() {
  group('OrderScreen - Initial State', () {
    testWidgets('displays the initial UI elements correctly',
      ...
      // Verify cart indicator in AppBar
  ...
  group('OrderScreen - Interactions', () {
    ...
    testWidgets('quantity does not go below zero and buttons are disabled',
      ...
      // Find the quantity text specifically (bold text with larger font size)
      final Finder quantityTextFinder = find.byWidgetPredicate(
        (widget) =>
            widget is Text &&
            widget.data == '0' &&
      ...
      // Should still be zero and buttons should still be disabled
      final Finder quantityText2 = find.byWidgetPredicate(
        (widget) =>
            widget is Text &&
            widget.data == '0' &&
            widget.style?.fontWeight == FontWeight.bold,
      );
      expect(quantityText2, findsOneWidget);
    });
